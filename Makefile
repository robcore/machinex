...
###############
#LATEST_CORTEX#
#CROSS_COMPILE	?=/opt/toolchains/arm-cortex_a15-linux-gnueabihf/bin/arm-cortex_a15-linux-gnueabihf-
##############
...
#########
#ROBCORE'S TOOLCHAIN
CROSS_COMPILE	?=/root/x-tools/arm-cortex_a15-linux-gnueabihf/bin/arm-cortex_a15-linux-gnueabihf-
#########
...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -Wno-unused-variable -Wno-maybe-uninitialized \
		   ...
		   -fno-aggressive-loop-optimizations -Wno-sequence-point -Wno-misleading-indentation -Wno-format-truncation #-Wformat=2 -Wformat-signedness
