...
/* Tunables */
static const int sync_read_expire  = 50;	/* max time before a sync read is submitted. */
static const int sync_write_expire = 200;	/* max time before a sync write is submitted. */
