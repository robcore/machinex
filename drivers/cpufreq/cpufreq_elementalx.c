...
int ex_set_two_phase_freq(int cpufreq)
{
	int i  = 0;
	for ( i = 0 ; i < NR_CPUS; i++)
...
void ex_set_two_phase_freq_by_cpu ( int cpu_nr, int cpufreq){
...
void ex_set_input_event_min_freq_by_cpu ( int cpu_nr, int cpufreq){
