...
static unsigned long boost_threshold = 1451ul;
static unsigned long thirdgear = 775ul;
static unsigned long secondgear = 659ul;
static unsigned long firstgear = 475ul;
