...
static unsigned long boost_threshold = 1551ul;
static unsigned long thirdgear = 805ul;
static unsigned long secondgear = 709ul;
static unsigned long firstgear = 505ul;
