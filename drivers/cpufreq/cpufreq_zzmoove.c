...
#if (defined(CONFIG_POWERSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined (DISABLE_POWER_MANAGEMENT)) || defined(USE_LCD_NOTIFIER)
...
#if defined(CONFIG_POWERSUSPEND) && !defined(USE_LCD_NOTIFIER)
static void powersave_power_suspend(struct early_suspend *handler)
...
#if defined(CONFIG_POWERSUSPEND) && !defined(USE_LCD_NOTIFIER) && !defined (DISABLE_POWER_MANAGEMENT)
static struct power_suspend __refdata _powersave_early_suspend = {
...
#endif
#endif /* (CONFIG_POWERSUSPEND || CONFIG_POWERSUSPEND && !DISABLE_POWER_MANAGEMENT) || USE_LCD_NOTIFIER */
