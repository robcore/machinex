...
store_one_cpu0_clamp(iactive_target_load, 1, 95);
...
store_one_cpu1_clamp(iactive_target_load, 1, 95);
...
store_one_cpu2_clamp(iactive_target_load, 1, 95);
...
store_one_cpu3_clamp(iactive_target_load, 1, 95);
