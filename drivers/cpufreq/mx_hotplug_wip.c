...
static unsigned long boost_threshold = 1351ul;
static unsigned long thirdgear = 755ul;
static unsigned long secondgear = 629ul;
static unsigned long firstgear = 455ul;
