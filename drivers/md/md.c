...
void md_trim_bio(struct bio *bio, int offset, int size)
{
	...
	while (bio->bi_iter.bi_idx < bio->bi_vcnt &&
	       bio->bi_io_vec[bio->bi_iter.bi_idx].bv_len <= offset) {
		/* remove this whole bio_vec */
		offset -= bio->bi_io_vec[bio->bi_iter.bi_idx].bv_len;
		bio->bi_iter.bi_idx++;
	}
	if (bio->bi_iter.bi_idx < bio->bi_vcnt) {
		bio->bi_io_vec[bio->bi_iter.bi_idx].bv_offset += offset;
		bio->bi_io_vec[bio->bi_iter.bi_idx].bv_len -= offset;
	}
