...
#define AN30259A_MAX_CURRENT_PROPOSITION(color, max_current) \
...
#else
		AN30259A_MAX_CURRENT_PROPOSITION(R, RED_LED_MAX_CURRENT);
		AN30259A_MAX_CURRENT_PROPOSITION(G, GREEN_LED_MAX_CURRENT);
		AN30259A_MAX_CURRENT_PROPOSITION(B, BLUE_LED_MAX_CURRENT);		
#endif			
