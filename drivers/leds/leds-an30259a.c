...
*/
	case POWERING:
		...
		leds_on(LED_B, true, true, LED_DYNAMIC_CURRENT);
		leds_set_slope_mode(client, LED_R,
				0, 15, 11, 0, 6, 5, 4, 10, 10, 4);
		leds_set_slope_mode(client, LED_G,
				0, 15, 11, 0, 6, 5, 4, 10, 10, 4);
		leds_set_slope_mode(client, LED_B,
				0, 0, 0, 15, 6, 5, 4, 10, 10, 4);
		break;
...
*/
	case BOOTING:
		...
		leds_on(LED_G, true, true, LED_G_CURRENT);
		leds_on(LED_B, true, true, LED_B_CURRENT);
		leds_set_slope_mode(client, LED_R, 0, 15, 5, 0, 1, 0, 2, 1, 1, 0);
		leds_set_slope_mode(client, LED_G, 0, 15, 5, 0, 1, 0, 2, 1, 1, 0);
		leds_set_slope_mode(client, LED_B, 0, 0, 0, 15, 0, 1, 2, 1, 1, 0);
