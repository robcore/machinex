...
*/
	case POWERING:
		...
		leds_on(LED_B, true, true, LED_DYNAMIC_CURRENT);
		leds_set_slope_mode(client, LED_R,
				0, 15, 0, 0, 5, 0, 5, 4, 4, 4, 4);
		leds_set_slope_mode(client, LED_G,
				0, 10, 15, 10, 5, 5, 4, 4, 4, 4);
		leds_set_slope_mode(client, LED_B,
				0, 0, 0, 15, 0, 5, 4, 4, 4, 4);
		break;
...
*/
	case BOOTING:
		...
		leds_set_slope_mode(client, LED_G, 0, 10, 15, 10, 1, 1, 2, 1, 1, 2);
		leds_set_slope_mode(client, LED_B, 0, 0, 0, 15, 0, 0, 1, 1, 1, 2);
