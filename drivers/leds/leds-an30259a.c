	...
	case CHARGING:
		...
		case BATTERY_MIDLOW:
				if (breathing_leds) {
					...
					leds_on(LED_R, true, false, 0xEA);
					leds_on(LED_G, true, false, 0xE2);
				}
				break;
		case BATTERY_MID:
				if (breathing_leds) {
					leds_on(LED_R, true, true, 0x78);
					leds_on(LED_G, true, true, 0xAA);
					leds_set_slope_mode(client, LED_R,
							0, 15, 10, 0, 2, 2, 1, 1, 1, 1);
					leds_set_slope_mode(client, LED_G,
							0, 15, 10, 0, 2, 2, 1, 1, 1, 1);
				} else {
					leds_on(LED_R, true, false, 0x78);
					leds_on(LED_G, true, false, 0xAA);
				}
				break;
		...
		case BATTERY_HIGH:
				if (breathing_leds) {
					...
					leds_on(LED_G, true, true, 0xFE);
					leds_on(LED_B, true, true, 0x9B);
					leds_set_slope_mode(client, LED_R,
							0, 15, 10, 0, 2, 2, 1, 1, 1, 1);
					leds_set_slope_mode(client, LED_G,
							0, 15, 10, 0, 2, 2, 1, 1, 1, 1);
					...
					leds_on(LED_G, true, false, 0xFE);
					leds_on(LED_B, true, false, 0x9B);
				}
				break;
		}
		break;
