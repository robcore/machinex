...
*/
	case POWERING:
		...
		leds_set_slope_mode(client, LED_R,
				0, 0, 0, 3, 4, 3, 4, 4, 4, 4);
		leds_set_slope_mode(client, LED_G,
				0, 15, 15, 5, 4, 3, 4, 4, 4, 4);
		leds_set_slope_mode(client, LED_B,
				0, 15, 0, 0, 4, 3, 4, 4, 4, 4);
		break;
...
*/
	case BOOTING:
		...
		leds_on(LED_G, true, true, LED_G_CURRENT);
		leds_on(LED_B, true, true, LED_B_CURRENT);
		leds_set_slope_mode(client, LED_R, 0, 0, 0, 3, 3, 2, 2, 2, 2, 2);
		leds_set_slope_mode(client, LED_G, 0, 15, 15, 5, 3, 2, 2, 2, 2, 2);
		leds_set_slope_mode(client, LED_B, 0, 15, 0, 0, 3, 2, 2, 2, 2, 2);
