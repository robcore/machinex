...
*/
	case BOOTING:
		...
		leds_on(LED_G, true, true, LED_G_CURRENT);
		leds_on(LED_B, true, true, LED_B_CURRENT);
		leds_set_slope_mode(client, LED_R, 0, 0, 0, 5, 0, 1, 0, 0, 0, 0);
		leds_set_slope_mode(client, LED_G, 0, 15, 15, 5, 0, 1, 0, 0, 0, 0);
		leds_set_slope_mode(client, LED_B, 0, 15, 0, 0, 0, 1, 0, 0, 0, 0);
