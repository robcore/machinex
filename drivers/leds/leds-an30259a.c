...
static void an30259a_start_led_pattern(int mode)
{
	...
	case BOOTING:
		...
		leds_on(LED_G, true, true, LED_B_CURRENT);
		leds_on(LED_B, true, true, LED_G_CURRENT);
		leds_set_slope_mode(client, LED_B, 0, 15, 7, 3, 1, 1, 2, 1, 1, 2);
		leds_set_slope_mode(client, LED_G, 0, 0, 7, 15, 1, 1, 2, 1, 1, 2);
		break;
