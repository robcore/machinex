...
*/
	case POWERING:
		...
		leds_set_slope_mode(client, LED_R,
				0, 0, 0, 2, 4, 2, 4, 4, 4, 4);
		leds_set_slope_mode(client, LED_G,
				0, 15, 15, 14, 4, 2, 4, 4, 4, 4);
		leds_set_slope_mode(client, LED_B,
				0, 15, 0, 0, 4, 2, 4, 4, 4, 4);
		break;
...
*/
	case BOOTING:
		...
		leds_on(LED_G, true, true, LED_G_CURRENT);
		leds_on(LED_B, true, true, LED_B_CURRENT);
		leds_set_slope_mode(client, LED_R, 0, 0, 0, 2, 2, 1, 2, 2, 2, 2);
		leds_set_slope_mode(client, LED_G, 0, 15, 15, 14, 2, 1, 2, 2, 2, 2);
		leds_set_slope_mode(client, LED_B, 0, 15, 0, 0, 2, 1, 2, 2, 2, 2);
