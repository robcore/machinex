...
void dump_cpu_stat(void)
{
	...
	"%llu\n",
	(unsigned long long)nsecs_to_jiffies(user),
	(unsigned long long)nsecs_to_jiffies(nice),
	(unsigned long long)nsecs_to_jiffies(system),
	(unsigned long long)nsecs_to_jiffies(idle),
	(unsigned long long)nsecs_to_jiffies(iowait),
	(unsigned long long)nsecs_to_jiffies(irq),
	(unsigned long long)nsecs_to_jiffies(softirq),
