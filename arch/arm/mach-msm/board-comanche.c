...
#endif
#if defined(CONFIG_INPUT_BMP180) || defined(CONFIG_OPTICAL_TAOS_TRITON) || defined(CONFIG_INPUT_YAS_SENSORS)
enum {
	SNS_PWR_OFF,
	SNS_PWR_ON,
	SNS_PWR_KEEP
...
static int phy_settings[] = {
	...
	0x4F, 0x81, /* update DC voltage level */
...
static void mxt224_read_ta_status(void *ta_status)
{
	...
	if (set_cable_status == CABLE_TYPE_AC
		...
		*(enum cable_type_t *)ta_status = set_cable_status;
#endif
...
#if defined CONFIG_SENSORS_CM36651 || defined(CONFIG_OPTICAL_TAOS_TRITON)
	&opt_i2c_gpio_device,
#endif
#if defined(CONFIG_INPUT_YAS_SENSORS)
...
/*KEY REV*/
	...
	|| defined(CONFIG_SENSORS_CM36651) || defined(CONFIG_OPTICAL_TAOS_TRITON)
