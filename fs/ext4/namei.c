...
#ifdef CONFIG_SDCARD_FS_CI_SEARCH
	new_bh = ext4_find_entry(new_dir, &new_dentry->d_name, &new_de, NULL, &new_inlined);
#else
...
#ifdef CONFIG_SDCARD_FS_CI_SEARCH
		old_bh2 = ext4_find_entry(old_dir, &old_dentry->d_name, &old_de2, NULL, NULL);
#else
