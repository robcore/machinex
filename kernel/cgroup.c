...
{
	int retval, i;
	struct cgroup_task_iter it = {0, 0};
...
bool css_is_ancestor(struct cgroup_css *child,
			...
			struct cgroup *child)
{
	...
	struct cgroup_css *parent_css, *child_css;
 ...
 * @id: the id
 *
 * Returns pointer to cgroup_css if there is valid one with id.
