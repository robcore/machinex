...
perf_cgroup_css_alloc(struct cgroup_css *parent_css)
{
...
static void perf_cgroup_css_free(struct cgroup_css *css)
{
...
static void perf_cgroup_attach(struct cgroup_css *css,
...
static void perf_cgroup_exit(struct cgroup_css *css,
