cmd_arch/arm/mach-msm/qdsp6v2/rtac.o := /media/root/robcore/android/machinex/scripts/gcc-wrapper.py /opt/toolchains/arm-cortex_a15-linux-gnueabihf_5.3/bin/arm-cortex_a15-linux-gnueabihf-gcc -Wp,-MD,arch/arm/mach-msm/qdsp6v2/.rtac.o.d  -nostdinc -isystem /opt/toolchains/arm-cortex_a15-linux-gnueabihf_5.3/bin/../lib/gcc/arm-cortex_a15-linux-gnueabihf/5.3.0/include -I/media/root/robcore/android/machinex/arch/arm/include -Iarch/arm/include/generated -Iinclude  -I/media/root/robcore/android/machinex/include -include /media/root/robcore/android/machinex/include/linux/kconfig.h  -I/media/root/robcore/android/machinex/arch/arm/mach-msm/qdsp6v2 -Iarch/arm/mach-msm/qdsp6v2 -D__KERNEL__ -mlittle-endian   -I/media/root/robcore/android/machinex/arch/arm/mach-msm/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -Wno-unused-variable -Wno-maybe-uninitialized -fno-strict-aliasing -fno-common -mtune="cortex-a15" -mfpu=neon-vfpv4 -std=gnu89 -Wno-format-security -Wno-unused-function -Wno-unused-label -Wno-array-bounds -Wno-logical-not-parentheses -fno-delete-null-pointer-checks -Wno-cpp -Wno-declaration-after-statement -fno-var-tracking-assignments -Wno-sizeof-pointer-memaccess -Wno-aggressive-loop-optimizations -Wno-sequence-point -O2 -marm -fno-dwarf2-cfi-asm -fstack-protector -mabi=aapcs-linux -mno-thumb-interwork -funwind-tables -D__LINUX_ARM_ARCH__=7 -mcpu=cortex-a15 -msoft-float -Uarm -Wframe-larger-than=1024 --param=allow-store-data-races=0 -Wno-unused-but-set-variable -fomit-frame-pointer -fno-var-tracking-assignments -g -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -DCC_HAVE_ASM_GOTO   -mcpu=cortex-a15 -mtune=cortex-a15 -mfpu=neon-vfpv4 -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(rtac)"  -D"KBUILD_MODNAME=KBUILD_STR(rtac)" -c -o arch/arm/mach-msm/qdsp6v2/.tmp_rtac.o /media/root/robcore/android/machinex/arch/arm/mach-msm/qdsp6v2/rtac.c

source_arch/arm/mach-msm/qdsp6v2/rtac.o := /media/root/robcore/android/machinex/arch/arm/mach-msm/qdsp6v2/rtac.c
...
deps_arch/arm/mach-msm/qdsp6v2/rtac.o := \
  ...
  /media/root/robcore/android/machinex/include/linux/msm_audio_acdb.h \
  /media/root/robcore/android/machinex/include/linux/msm_audio.h \
  /media/root/robcore/android/machinex/arch/arm/mach-msm/include/mach/qdsp6v2/audio_acdb.h \
    $(wildcard include/config/arch/msm8974.h) \
  /media/root/robcore/android/machinex/include/sound/q6adm.h \
  /media/root/robcore/android/machinex/include/sound/q6afe.h \
  ...
  /media/root/robcore/android/machinex/arch/arm/mach-msm/include/mach/qdsp6v2/rtac.h \
