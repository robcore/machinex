cmd_security/selinux/ss/conditional.o := /root/machinex/scripts/gcc-wrapper.py /opt/toolchains/arm-cortex_a15-linux-gnueabihf_5.3/bin/arm-cortex_a15-linux-gnueabihf-gcc -Wp,-MD,security/selinux/ss/.conditional.o.d  -nostdinc -isystem /opt/toolchains/arm-cortex_a15-linux-gnueabihf_5.3/bin/../lib/gcc/arm-cortex_a15-linux-gnueabihf/5.3.0/include -I/root/machinex/arch/arm/include -Iarch/arm/include/generated -Iinclude  -I/root/machinex/include -include /root/machinex/include/linux/kconfig.h  -I/root/machinex/security/selinux -Isecurity/selinux -D__KERNEL__ -mlittle-endian   -I/root/machinex/arch/arm/mach-msm/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -Wno-unused-variable -Wno-maybe-uninitialized -fno-strict-aliasing -fno-common -mtune=cortex-a15 -mfpu=neon-vfpv4 -std=gnu89 -Wno-format-security -Wno-unused-function -Wno-unused-label -Wno-array-bounds -Wno-logical-not-parentheses -fno-delete-null-pointer-checks -Wno-cpp -Wno-declaration-after-statement -fno-var-tracking-assignments -Wno-sizeof-pointer-memaccess -Wno-aggressive-loop-optimizations -Wno-sequence-point -O3 -marm -fno-dwarf2-cfi-asm -fstack-protector -fno-conserve-stack -fno-ipa-sra -mabi=aapcs-linux -mno-thumb-interwork -funwind-tables -D__LINUX_ARM_ARCH__=7 -mcpu=cortex-a15 -mtune=cortex-a15 -msoft-float -Uarm -Wframe-larger-than=2048 --param=allow-store-data-races=0 -Wno-unused-but-set-variable -fomit-frame-pointer -fno-var-tracking-assignments -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -DCC_HAVE_ASM_GOTO  -I/root/machinex/security/selinux -Isecurity/selinux  -I/root/machinex/security/selinux/include -Isecurity/selinux/include   -mcpu=cortex-a15 -mtune=cortex-a15 -mfpu=neon-vfpv4  -mvectorize-with-neon-quad -munaligned-access -fgraphite-identity -floop-parallelize-all -ftree-loop-linear -floop-interchange -floop-strip-mine -floop-block -ftree-vectorize -funroll-loops -fno-align-functions -fno-align-jumps -fno-align-loops -fno-align-labels -fno-prefetch-loop-arrays -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(conditional)"  -D"KBUILD_MODNAME=KBUILD_STR(selinux)" -c -o security/selinux/ss/.tmp_conditional.o /root/machinex/security/selinux/ss/conditional.c

source_security/selinux/ss/conditional.o := /root/machinex/security/selinux/ss/conditional.c
...
deps_security/selinux/ss/conditional.o := \
  ...
  /root/machinex/security/selinux/include/security.h \
  ...
  /root/machinex/security/selinux/ss/conditional.h \
  /root/machinex/security/selinux/ss/avtab.h \
  /root/machinex/security/selinux/ss/symtab.h \
  /root/machinex/security/selinux/ss/hashtab.h \
  /root/machinex/security/selinux/ss/policydb.h \
    $(wildcard include/config/mls.h) \
  /root/machinex/include/linux/flex_array.h \
  /root/machinex/security/selinux/ss/sidtab.h \
  /root/machinex/security/selinux/ss/context.h \
  /root/machinex/security/selinux/ss/ebitmap.h \
  /root/machinex/include/net/netlabel.h \
  ...
  /root/machinex/security/selinux/ss/mls_types.h \
  /root/machinex/security/selinux/ss/constraint.h \
  /root/machinex/security/selinux/ss/../include/conditional.h \
