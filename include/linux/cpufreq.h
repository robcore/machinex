...
struct mx_cpufreq_policy {
	struct cpufreq_governor	*governor; /* see below */
	char			perm_governor[CPUFREQ_NAME_LEN]; /* permanent gov */
...
void cpufreq_verify_within_thermal_limits(unsigned int cpu, unsigned int max);
void
...
/*
 * Governor specific info that can be passed to modules.
 */
...
{
	/*
	 * Allow remote callbacks if the local and remote CPUs share cpufreq policy
	 */
