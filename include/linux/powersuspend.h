 ...
 *
 * v1.8.0 - Make Panel the ONLY available option, and completely remove
 *			the ability to write to sysfs.
 *
 *
...
#define POWER_SUSPEND_PANEL	1	// Use display panel state as hook
